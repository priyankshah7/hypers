...
setup(
    name='scikit-hyper',
    version='0.0.1',
    packages=['skhyper', 'skhyper.view', 'skhyper.cluster', 'skhyper.process', 'skhyper.decomposition'],
    ...
    keywords=['hyperspectral', 'data-analysis', 'clustering', 'matrix-decompositions', 'hyperspectral-analysis',
              'machine learning'],
