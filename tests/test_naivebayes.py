...
class TestNaiveBayes:
    ...
    def test_gaussiannb(self):
        ...
        assert mdl_3d.class_prior_ is not None
        assert mdl_3d.class_count_ is not None
        assert mdl_3d.theta_ is not None
        assert mdl_3d.sigma_ is not None
        ...
        assert mdl_4d.class_prior_ is not None
        assert mdl_4d.class_count_ is not None
        assert mdl_4d.theta_ is not None
        assert mdl_4d.sigma_ is not None
